(function($){
   ...
   //active
    ...
    //datatable
    var table=$('#citcha_table').DataTable( {
        ...
        "columns": [
            ...
            {data:"date_service_rendered"},
            {data:"date_doc_released"},
            {
                data: null,
                render: function(data, type, row) {
                  if (data.client_type == 1) {
                    ...
                    // Handle other cases, maybe return a default value
                    return "Government(Employee or from another agency)"; // You can replace "default" with your preferred fallback value
                  }
                }
              },
            {data:"name"},
            ...
            //{data:"age"},
            {
                ...
                render: function(data, type, row) {
                  if (data.age == 1) {
                    ...
                    return "65 y/o and above"; // You can replace "default" with your preferred fallback value
                  }
                }
              },
            {data:"gender"},
            {
                ...
                return data.office_.office_desc;
                }
                }
            },
     ...
     $('#filter_month_cc').on('change',function(){
      ...
      //datatable
    var table=$('#csr1_table').DataTable( {
        dom: "<'row'<'col-sm-4'l><'col-sm-4'B><'col-sm-4'f>>" +
        "<'row'<'col-sm-12'tr>>" +
        "<'row'<'col-sm-4'i><'col-sm-8'p>>",
        buttons: [
...
$('#services').select2({
    width:"100%",
    placeholder:trans("Please select the service you availed"),
    ajax: {
       beforeSend:function()
       {
          $('.preloader').show();
