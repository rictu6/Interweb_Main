    ...
    var table=$('#prop_issued_table').DataTable( {
        ...
        "columns": [
            ...
            {data:"reference"},
            {
                ...
                if (data.status === 0) {
                    qty=data.issued_qty;
                    return data.issued_qty;
                } else if (data.status === 1){
                    qty=data.returned_qty;
                    return data.returned_qty;
                }else {
                    qty=data.re_issued_qty;
                    return data.re_issued_qty;
                }
                }
              },
              {data:"amount"},
              {
                ...
                render: function(data, type, row) {
                    ...
                    //for (var i = 0; i < data.details.length; i++) {
                        totalAmount += parseFloat(data.amount *qty);
                    //}
            ...
            {data:"ics_rrsp_no"},
            {
              ...
              },
              {
                ...
                if (data.status === 0) {
                    ...
                    return data.issued_office;
                } else if (data.status === 1){

                    return data.returned_office;
                }else {

                    return data.re_issued_office;
                }
                }
              },
            {data:"balance_qty"},
