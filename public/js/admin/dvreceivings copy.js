                        ...
                        <td>
                            <div class="form-group">
                                <div class="input-group form-group mb-3">
                                    <input type="number" class="form-control amount" name="details[${count}][amount]" min="0" class="amount" id="amount${count}" value="${item.amount}" required>
