   ...
   //active
    ...
    var table=$('#ftas_table').DataTable( {
        ...
        "bSort" : false,
          ...
          "columns": [
            {data:"fta_id"},
            {data:"local_chief_exec.fullname"},
            {data:"leavetype"},
            {data:"destination"},
            {data:"local_chief_exec.designation"},
            {data:"local_chief_exec.province.prov_desc"},

            {data:"local_chief_exec.muncit.muncit_desc",
            render: function ( data, type, row ) {
               var muncit;
                   if(row.local_chief_exec.muncit===null){
                   muncit=  row.local_chief_exec.province.prov_desc;
                   //muncit=  row.local_chief_exec.muncit.muncit_desc
                   }else{
                     //muncit=  row.local_chief_exec.province.prov_desc;
                     muncit= row.local_chief_exec.muncit.muncit_desc;
                   }
            ...
            // {data:"local_chief_exec.muncit.muncit_desc",
            // "defaultContent": "local_chief_exec.province.prov_desc"},
            {data:"datefrom"},
            {data:"dateto"},
