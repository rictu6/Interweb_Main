        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" id="start" placeholder="{{__('Start')}}" name="start"
                    @if(isset($user)) value="{{$user['start']}}" @endif @if(isset($user)&&$user['is_submitted']==1)
                    selected readonly @endif>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" id="end" placeholder="{{__('End')}}" name="end"
                    @if(isset($user)) value="{{$user['end']}}" @endif @if(isset($user)&&$user['is_submitted']==1)
                    selected readonly @endif>
                <input type="time" class="form-control" id="time_end" placeholder="{{__('End Time')}}" name="time_end"
                    @if(isset($user)) value="{{$user['time_end']}}" @endif @if(isset($user)&&$user['is_submitted']==1)
                    selected readonly @endif>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="input-group form-group mb-3">
                ...
                <select class="form-control" id="ret" name="status" placeholder="{{__('Status')}}" id="status">
