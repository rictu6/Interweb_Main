...
@section('title')
{{__('REPORT OF SEMI-EXPENDABLE PROPERTY ISSUED')}}
@endsection
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{__('REPORT OF SEMI-EXPENDABLE PROPERTY ISSUED')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
@section('content')
    <div class="card card-primary">
        ...
        <h3 class="card-title">{{__('REPORT OF SEMI-EXPENDABLE PROPERTY ISSUED')}}</h3>
        </div>
        <!-- /.card-header -->
        <!-- card-body -->
        <div class="card-body">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-12 text-center">
                          <a class="btn btn-success" href="{{route('admin.repsepi.export')}}">
...
<script src="{{ url('js/admin/repsepi.js') }}"></script>
@endsection
