...
class RSepiERepSepiExportxport implements FromView, WithColumnFormatting, WithCustomStartCell, WithEvents,ShouldAutoSize
{
    public function view(): View
    {
        return view('admin.repsepi._export', [
